...
Tóm tắt theo đúng 7 bước: (1) FEATURE OVERVIEW, (2) ACTOR & USER ROLE, (3) BUSINESS RULES (đánh số), (4) HAPPY PATH, (5) ALTERNATE FLOWS, (6) OUT OF SCOPE, (7) OPEN QUESTIONS (≥5 câu hỏi cần hỏi BA, bao gồm mọi trường hợp 2 nguồn tài liệu mâu thuẫn nhau — KHÔNG tự chọn nguồn nào đúng). Gắn tag `[GIẢ ĐỊNH]` cho mọi thông tin không có trong tài liệu gốc nhưng cần giả định để viết tiếp.
...
## Quality Check
- Faithful: không suy diễn ngoài những gì tài liệu có, mọi giả định đều gắn `[GIẢ ĐỊNH]`.
- Complete: đủ 7 phần, phần 7 (Open Questions) không được bỏ trống nếu phát hiện mâu thuẫn.
- Traceable: mỗi business rule nên chỉ rõ trích từ file nào khi có thể.
