...
- Task được giao trong `.state/task-assignment.md`.
...
- **Chỉ đọc** `.state/task-assignment.md`.
- **Chỉ ghi** `.state/deliverable.md`.
- Không ghi đè `.state/task-assignment.md`.
- Không tạo `deliverable_v2.md`, `deliverable_round2.md`, hoặc các file deliverable khác.

Mỗi lần được QA Leader yêu cầu FIX:

1. Đọc lại `.state/task-assignment.md`.
2. Đọc feedback của round hiện tại.
3. Kiểm tra lại source documents liên quan.
4. Sửa `.state/deliverable.md`.
5. Ghi đè vào đúng `.state/deliverable.md`.
...
Trước khi ghi `.state/deliverable.md`, QA Analyst phải đảm bảo:
...
5. Đã ghi kết quả vào `.state/deliverable.md`.
